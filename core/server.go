...
func (s *Server) setupRouter() {
	...
	sr.HandleFunc("/update/check", api.UpdateOptionsHandler).Methods("OPTIONS")
	sr.HandleFunc("/update/check", api.UpdateCheckHandler).Methods("GET")
	sr.HandleFunc("/update/apply", api.UpdateOptionsHandler).Methods("OPTIONS")
	sr.HandleFunc("/update/apply", api.UpdateApplyHandler).Methods("POST")
